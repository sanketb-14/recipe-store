        ...
        <div className="flex flex-col">
          ...
          <ul className="grid grid-cols-3  gap-1 items-center text-lg">
            {dietaryPreference.map(item => (
              <li key={item} className="p-1 mx-2 m-2 justify-start  bg-accent/50 text-accent-content lowercase text-sm text-nowrap flex  items-center">
          ...
          <ul className="grid grid-cols-3  gap-1 items-center text-lg">
            {ingredients.map(item => (
              <li key={item} className="p-1 mx-2 m-2 justify-start  border-r-2 border-secondary text-sm text-nowrap flex  items-center">
          ...
          <ul className="grid grid-cols-1  gap-1 items-center text-lg">
            {instructions.map(item => (
              <li key={item} className="p-1 mx-2  justify-start rounded-xl bg-base-200 text-secondary text-sm text-nowrap flex items-center">
