...
export const signup = catchAsync(async (req, res, next) => {
  ...
  const boyProfilePic = `https://xsgames.co/randomusers/assets/avatars/male/${Math.floor(
    Math.random() * 100
  )}.jpg`;
  const girlProfilePic = `https://xsgames.co/randomusers/assets/avatars/female/${Math.floor(
    Math.random() * 100
  )}.jpg`;
